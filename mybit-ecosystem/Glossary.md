...
|Gas   | Upon creation, each transaction is charged with a certain amount of gas. The gas price is a value set by the creator of the transaction, who has to pay gas_price * gas up front from the sending account.  |
